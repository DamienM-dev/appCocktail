...
public class WhiskyPageActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_whisky_page);

        RecyclerView recyclerView = findViewById(R.id.whisky_recycler_view);
        ...
        Cursor c= persistance.selectWhisky();
