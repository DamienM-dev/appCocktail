...
public class RecipeCocktailDataBase extends SQLiteOpenHelper {
    ...
    public void addRecipe(String name, String ingredient, String recette, Bitmap image) {

        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();


        values.put("name", "Rum Runner");
        ...
        values.put("image", "https://zupimages.net/up/23/03/l01s.jpg");
